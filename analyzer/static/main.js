...
var AppComponent = /** @class */ (function () {
    function AppComponent(routeService) {
        ...
        this.zoom = 15;
        this.sub = null; // holds subscription to stop drawing individual route when new one is selected
    }
    ...
    AppComponent.prototype.getColor = function (index) {
    ...
    AppComponent.prototype.onRouteSelected = function (route_id) {
        ...
        this.routeService.loadRoute(this.selectedRouteId).subscribe(function (routePoints) {
            ...
            _this.zoom = 15;
            _this.sub = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(routePoints).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatAll"])()) // unpack the array into single emissions
